  ...
  return (
    <div id="webcrumbs"> 
      <div className="w-full bg-white rounded-lg shadow-lg min-h-[800px] flex">
        {/* Sidebar */}
        <aside className="w-64 bg-[#6E59A5] text-white rounded-l-lg flex flex-col p-6">
          <h2 className="text-xl font-semibold mb-6">Navigation</h2>
          <nav className="flex flex-col gap-4">
            <Link to="/dashboard" className="flex items-center gap-2 text-white hover:text-white/80 transition-colors">
              <LayoutDashboard size={20} />
              <span>Dashboard</span>
            </Link>
            <Link to="/users" className="flex items-center gap-2 text-white hover:text-white/80 transition-colors">
              <Users size={20} />
              <span>User Management</span>
            </Link>
            <Link to="/reports" className="flex items-center gap-2 text-white hover:text-white/80 transition-colors">
              <FileText size={20} />
              <span>Reports</span>
            </Link>
            <Link to="/settings" className="flex items-center gap-2 text-white hover:text-white/80 transition-colors">
              <Settings size={20} />
              <span>Settings</span>
            </Link>
          </nav>
